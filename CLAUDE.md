...
- Single-page app with hash routing (`#home`, `#charter`, `#archetypes`, `#curriculum`, `#references`, `#status`, `#about`)
- Client-side markdown rendering with marked.js (no build process)
- Landing page organized into DNA / Emergent / unlabeled meta groups
